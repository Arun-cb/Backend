...
def get_ydata_profiling_report(request):
    ...
    if db_type == 'MYSQL':
        ...
        try:
            ...
            dy = pd.DataFrame(results)

            report = ProfileReport(dy, title= query_name)
...
def get_range_rb_db_connect_table(request, start, end):
    ...
    serializer_csv_export = rb_db_connect_table_serializer(
...
def upd_rb_db_connect_table(request, id):
    ...
    serializer = rb_db_connect_table_serializer(
