...
class query_builder_table_columns(models.Model):
    ...
    sort_type = models.CharField(max_length=255, null=False, blank=False)
    sort_order = models.IntegerField(null=False, blank=False)
    sort_column = models.CharField(max_length=255, null=False, blank=False)
    group_by = models.CharField(max_length=255, null=True, blank=False)
    col_function = models.CharField(max_length=255, null=True, blank=False)
    column_display_order = models.IntegerField(null=False, blank=False)
...
class query_builder_table_groupBy(models.Model):
    ...
    having_finter_ind = models.CharField(max_length=1, null=True, blank=False)
